...
<a  href = "/image/simpleFileupload.htm">添加图片</a>
   ...
   <div class="form">
         <h3 class="title">变更股权</h3>
	   <form action="/equityrecord/saveEquity.htm" method="post">
			 <input name="id" id="id" type="hidden" value="${equityRecord.id}" />
	         <input name="staffid" id="staffid" type="hidden" value="${equityRecord.staffid}" />
	         <div class="form-group">
	               <label>变更股数:</label><input class="" type="text" name="num" required id="equityval" value="${equityRecord.num}">
	         </div>

	         <div class="form-btn"> 
	            <input type="submit" value="提交">  
	            <input type="button" value="取消" onclick="window.location.href='/equityrecord/list.htm'">
	         </div> 
         </form>  
   </div>
