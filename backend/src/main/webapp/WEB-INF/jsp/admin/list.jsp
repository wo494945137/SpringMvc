...
<table class="table">
	...
	<tbody id="table2">
		...
		<tr>
			...
			<td><a  href = "/admin/edit.htm?id=${var.id}"> <span>${var.name}</span> </a></td>
			<td> <span>${var.account}</span> </td>
			<td> <span>${var.password}</span> </td>
			<td><a  href = "/admin/del.htm?id=${var.id}"> <span>删除</span> </a> </td>                
		</tr>
		  </c:forEach>  
